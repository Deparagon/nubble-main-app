...
Route::get('/api/auth', function (Request $request) {
    ...
    file_get_contents(dirname(__FILE__).'/hereisthe_shop', print_r($shop, true));
...
Route::get('/api/auth/callback', function (Request $request) {
    ...
    if ($response->isSuccess()) {
        ...
        Log::error(
            "Failed to register PRODUCT_DELETE webhook for shop $shop with response body: " .
                print_r($response->getBody(), true)
        );
    }
    ...
    if ($response->isSuccess()) {
        ...
        Log::error(
            "Failed to register PRODUCT_UPDATE webhook for shop $shop with response body: " .
                print_r($response->getBody(), true)
        );
    }
...
Route::get('/api/keys/shopkey', function (Request $request) {
    /** @var AuthSession */
    $session = $request->get('shopifySession'); // Provided by the shopify.auth middleware, guaranteed to be active
